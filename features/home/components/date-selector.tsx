...
import { DATE_OPTIONS } from "../data/date-option";
  ...
  return (
    <View className="flex-row items-center justify-between rounded-lg">
      <>
        ...
        <TouchableOpacity onPress={() => router.replace("/(sentra-pay)/sentra-pay")}>
          ...
          <View className="bg-white rounded-t-3xl h-4/5 w-full p-5">
            ...
            <ScrollView className="mb-5">
              ...
              <View className="mt-1">
                ...
                >
                  <Text className="text-base font-bold text-black">Tanggal Mulai</Text>
